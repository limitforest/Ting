...
public class MainActivity extends FragmentActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mTabManager.addTab(tabWidget, getString(R.string.my_music), FirstFragment.class, null);
		mTabManager.addTab(tabWidget,  getString(R.string.my_music), FirstFragment.class, null);
		mTabManager.addTab(tabWidget,  getString(R.string.online_music), SecondFragment.class, null);
		mTabManager.addTab(tabWidget,  getString(R.string.search), FirstFragment.class, null);
